    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                # Records by status
                cursor.execute("SELECT status, COUNT(*) FROM user_data GROUP BY status")
                ...
                cursor.execute("SELECT AVG(quality_score) FROM user_data WHERE quality_score IS NOT NULL")
                ...
                return {
                    ...
                    'processed_records': status_counts.get('processed', 0),
