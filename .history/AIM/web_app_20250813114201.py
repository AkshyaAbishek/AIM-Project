...
def compare():
    ...
    try:
        ...
        # Convert to the format expected by the compare template
        ...
        print(f"Compare page: Found {len(processed_records)} records from view_data source")
        
        # If still no records found, add sample data for testing
        if not processed_records:
            print("No records found, adding sample data...")
            from datetime import datetime
            import json
            
            # Sample data
            sample_data = {
                "policy_number": "DEMO001",
                "applicant_first_name": "John",
                "applicant_last_name": "Demo",
            ...
            # Re-fetch records using the same method as view_data
            all_data = db_manager.get_all_data()
            processed_records = []
            for record in all_data:
                cursor.execute("""
            ...
            print(f"After adding sample data: Found {len(processed_records)} records")
...
if __name__ == '__main__':
    ...
    # Debug: Force restart to test compare page changes
