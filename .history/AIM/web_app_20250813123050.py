...
def compare():
    ...
    # Test if the issue is in variable assignment
    ...
    if processed_records:
        try:
            ...
            print(f"First record accessible: {type(first_record)}")
        ...
        try:
            ...
            with sqlite3.connect(db_manager.db_path) as conn:
                ...
                if direct_count > 0:
                    print("Records exist in database but get_all_data() returns empty!")
                    print("This suggests a bug in the get_all_data() method or database connection")
