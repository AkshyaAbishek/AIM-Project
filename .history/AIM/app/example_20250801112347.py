...
class AIMDemoGUI:
    ...
    def enter_custom_data(self):
        ...
        # Instructions
        instructions_text = """💡 Instructions: Enter valid JSON data below. You can modify the sample data or replace it completely.
Ensure all string values are in quotes and numbers are without quotes."""
        ...
        # Update sample data when product type changes
        for widget in radio_frame.winfo_children():
            if isinstance(widget, tk.Radiobutton):
                widget.configure(command=update_sample_data)
        ...
        def clear_data():
            ...
            text_area.mark_set(tk.INSERT, "2.2")
            text_area.focus()
        ...
        tk.Button(button_frame, text="🔄 Reset Sample", command=reset_sample, 
