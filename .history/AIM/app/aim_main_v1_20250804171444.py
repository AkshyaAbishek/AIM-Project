...
This script demonstrates how to use AIM to process actuarial input mapping
...
# It provides tools to create windows, dialogs, buttons, text fields, and other GUI elements.
# In this script, tkinter is used to build interactive windows for data entry, display, and user interaction.
            ...
            for i, record in enumerate(records, 1):
                ...
                try:
                    ...
                    if not exists:
                        ...
                        timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
                        cursor.execute('''
                            INSERT INTO user_data (timestamp, product_type, json_data, data_hash)
                            VALUES (?, ?, ?, ?)
