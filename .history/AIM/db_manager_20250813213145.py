...
class WebDatabaseManager:
    ...
    def get_data_by_id(self, record_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error retrieving record by id: {e}")
            return None
        
    def load_calculator_reference(self, calculator_path: str, product_type: str) -> dict:
        """Load calculator reference data from a file or return a default template."""
        # For now, return a default template for life and annuity
        if product_type == 'life':
            ...
            return {
                ...
                'version': '1.0',
                'fields': {
                    'contract_number': {'required': True, 'type': 'string', 'sample': 'ANU001234'},
                    'owner_name': {'required': True, 'type': 'string', 'sample': 'Jane Doe'},
                    'issue_date': {'required': True, 'type': 'date', 'sample': '2024-01-01'},
                    'interest_rate': {'required': True, 'type': 'number', 'sample': 0.035},
                    'premium': {'required': True, 'type': 'number', 'sample': 100000}
                }
            }
        else:
