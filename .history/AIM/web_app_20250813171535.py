...
# Get project root directory and update paths for new structure
project_root = os.path.dirname(__file__)  # AIM root directory
...
# Updated paths for new organized structure
